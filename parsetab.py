...
_lr_productions = [
  ...
  ('vars1 -> ID','vars1',1,'p_vars1','yacc.py',45),
  ('vars1 -> ID COMMA vars1','vars1',3,'p_vars1','yacc.py',46),
  ('tipo -> INT','tipo',1,'p_tipo','yacc.py',51),
  ('tipo -> FLOAT','tipo',1,'p_tipo','yacc.py',52),
  ('tipo -> STRING','tipo',1,'p_tipo','yacc.py',53),
  ('tipo -> BOOL','tipo',1,'p_tipo','yacc.py',54),
  ('bloque -> asignacion','bloque',1,'p_bloque','yacc.py',59),
  ('bloque -> condicion','bloque',1,'p_bloque','yacc.py',60),
  ('bloque -> lectura','bloque',1,'p_bloque','yacc.py',61),
  ('bloque -> escritura','bloque',1,'p_bloque','yacc.py',62),
  ('bloque -> loop','bloque',1,'p_bloque','yacc.py',63),
  ('bloque -> funcion','bloque',1,'p_bloque','yacc.py',64),
  ('asignacion -> ID EQUAL expresion SEMICOLON','asignacion',4,'p_asignacion','yacc.py',70),
  ('asignacion -> ID EQUAL array SEMICOLON','asignacion',4,'p_asignacion','yacc.py',71),
  ('asignacion -> ID EQUAL funcion SEMICOLON','asignacion',4,'p_asignacion','yacc.py',72),
  ('asignacion -> ID LCORCH exp RCORCH EQUAL expresion SEMICOLON','asignacion',7,'p_asignacion','yacc.py',73),
  ('expresion -> exp','expresion',1,'p_expresion','yacc.py',77),
  ('expresion -> exp relop exp expresion1','expresion',4,'p_expresion','yacc.py',78),
  ('expresion1 -> relop exp','expresion1',2,'p_expresion1','yacc.py',82),
  ('expresion1 -> empty','expresion1',1,'p_expresion1','yacc.py',83),
  ('relop -> GT','relop',1,'p_relop','yacc.py',88),
  ('relop -> LT','relop',1,'p_relop','yacc.py',89),
  ('relop -> GTE','relop',1,'p_relop','yacc.py',90),
  ('relop -> LTE','relop',1,'p_relop','yacc.py',91),
  ('relop -> DOUBLEEQUAL','relop',1,'p_relop','yacc.py',92),
  ('relop -> NE','relop',1,'p_relop','yacc.py',93),
  ('relop -> AND','relop',1,'p_relop','yacc.py',94),
  ('relop -> OR','relop',1,'p_relop','yacc.py',95),
  ('exp -> termino','exp',1,'p_exp','yacc.py',100),
  ('exp -> termino exp1','exp',2,'p_exp','yacc.py',101),
  ('exp1 -> PLUS exp','exp1',2,'p_exp1','yacc.py',106),
  ('exp1 -> MINUS exp','exp1',2,'p_exp1','yacc.py',107),
  ('termino -> factor','termino',1,'p_termino','yacc.py',112),
  ('termino -> factor termino1','termino',2,'p_termino','yacc.py',113),
  ('termino1 -> MULT termino','termino1',2,'p_termino1','yacc.py',118),
  ('termino1 -> DIV termino','termino1',2,'p_termino1','yacc.py',119),
  ('factor -> LPAREN expresion RPAREN','factor',3,'p_factor','yacc.py',124),
  ('factor -> PLUS var_cte','factor',2,'p_factor','yacc.py',125),
  ('factor -> MINUS var_cte','factor',2,'p_factor','yacc.py',126),
  ('factor -> var_cte','factor',1,'p_factor','yacc.py',127),
  ('var_cte -> ID','var_cte',1,'p_var_cte','yacc.py',132),
  ('var_cte -> CTE_I','var_cte',1,'p_var_cte','yacc.py',133),
  ('var_cte -> CTE_F','var_cte',1,'p_var_cte','yacc.py',134),
  ('var_cte -> CTE_S','var_cte',1,'p_var_cte','yacc.py',135),
  ('var_cte -> TRUE','var_cte',1,'p_var_cte','yacc.py',136),
  ('var_cte -> FALSE','var_cte',1,'p_var_cte','yacc.py',137),
  ('condicion -> IF LPAREN expresion RPAREN LKEY bloque RKEY','condicion',7,'p_condicion','yacc.py',142),
  ('condicion -> IF LPAREN expresion RPAREN LKEY bloque RKEY ELSE LKEY bloque RKEY','condicion',11,'p_condicion','yacc.py',143),
  ('lectura -> INPUT LPAREN ID RPAREN SEMICOLON','lectura',5,'p_lectura','yacc.py',148),
  ('escritura -> OUTPUT LPAREN exp RPAREN SEMICOLON','escritura',5,'p_escritura','yacc.py',153),
  ('array -> LCORCH array1 RCORCH','array',3,'p_array','yacc.py',158),
  ('array1 -> exp','array1',1,'p_array1','yacc.py',163),
  ('array1 -> exp COMMA array1','array1',3,'p_array1','yacc.py',164),
  ('loop -> LOOP LPAREN expresion RPAREN LKEY bloque RKEY','loop',7,'p_loop','yacc.py',171),
  ('funcion -> ID LPAREN funcion1 RPAREN','funcion',4,'p_funcion','yacc.py',176),
  ('funcion1 -> exp','funcion1',1,'p_funcion1','yacc.py',181),
  ('funcion1 -> exp COMMA funcion1','funcion1',3,'p_funcion1','yacc.py',182),
  ('modulo -> FUNC ID LPAREN modulo1 RPAREN LKEY vars modulo2 modulo3','modulo',9,'p_modulo','yacc.py',187),
  ('modulo1 -> tipo ID','modulo1',2,'p_modulo1','yacc.py',192),
  ('modulo1 -> tipo ID COMMA modulo1','modulo1',4,'p_modulo1','yacc.py',193),
  ('modulo2 -> bloque','modulo2',1,'p_modulo2','yacc.py',198),
  ('modulo2 -> bloque modulo2','modulo2',2,'p_modulo2','yacc.py',199),
  ('modulo3 -> RETURN exp SEMICOLON RKEY','modulo3',4,'p_modulo3','yacc.py',203),
  ('modulo3 -> RKEY','modulo3',1,'p_modulo3','yacc.py',204),
